...
function get_DB_CONFIG__From_ENV_File(string $ENV_File):mixed {
    ...
    if ($database_url) {
        ...
        $DB_CONFIG_arr["DB_Port"] = $parsed['port'] ?? 33860;  // Changed from 3306 to 33860
        ...
        $DB_CONFIG_arr["DB_Port"] = getenv("MYSQL_PORT") ?: "33860";
...
$db = db::open('mysqli', $DB_CONFIG['DB_Name'], $DB_CONFIG['DB_User'], $DB_CONFIG['DB_Pass'], $DB_CONFIG['DB_Host'], 33860);
//Init DB ###############################################
